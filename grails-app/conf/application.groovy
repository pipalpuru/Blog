...
// Added by the Spring Security Core plugin:
grails.plugin.springsecurity.userLookup.userDomainClassName = 'myblogapp.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'myblogapp.UserRole'
grails.plugin.springsecurity.authority.className = 'myblogapp.Role'
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	[pattern: '/',               access: ['permitAll']],
	[pattern: '/error',          access: ['permitAll']],
	[pattern: '/index',          access: ['permitAll']],
